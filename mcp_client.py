...
class MCPClient:
    ...
    async def connect_to_servers(self):
        ...
        # It actually starts the mcp server and then maintaints a connection with the server.
    ...
    # This is the main method which given a user query, will make llm calls and tool calls and then return the final response
    async def process_query(self, query: str):
        ...
        # TODO: The below while loop should go into process_query. That way we can use process_query for handling queries from api calls too.
